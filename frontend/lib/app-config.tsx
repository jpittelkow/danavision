...
export function AppConfigProvider({ children }: { children: React.ReactNode }) {
  ...
  React.useEffect(() => {
    if (query.data && !query.isLoading) {
      ...
      const userOverride = localStorage.getItem("danavision-color-theme");
      ...
      if (colorTheme) {
        localStorage.setItem("danavision-global-color-theme", colorTheme);
      } else {
        localStorage.removeItem("danavision-global-color-theme");
      }
