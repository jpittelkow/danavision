          ...
          <CardContent className="space-y-4">
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="port" type="number" {...register("port", { valueAsNumber: true })} placeholder="587" />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="username" {...register("username")} placeholder="your-email@example.com" />
                  </div>
                  <div className="space-y-2">
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="mailgun_domain" {...register("mailgun_domain")} placeholder="mg.example.com" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="mailgun_secret">Secret Key</Label>
                    <Input id="mailgun_secret" type="password" {...register("mailgun_secret")} placeholder="Your Mailgun secret" />
                  </div>
                </div>
              </>
            )}
            ...
            {provider === "sendgrid" && (
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="sendgrid_api_key" type="password" {...register("sendgrid_api_key")} placeholder="Your SendGrid API key" />
                </div>
              </>
            )}
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="ses_key" {...register("ses_key")} placeholder="Your AWS access key" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="ses_secret">Secret Access Key</Label>
                    <Input id="ses_secret" type="password" {...register("ses_secret")} placeholder="Your AWS secret key" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="ses_region">Region</Label>
                  <Input id="ses_region" {...register("ses_region")} placeholder="us-east-1" />
                </div>
              </>
            )}
            ...
            {provider === "postmark" && (
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="postmark_token" type="password" {...register("postmark_token")} placeholder="Your Postmark token" />
                </div>
              </>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="from_address" type="email" {...register("from_address")} placeholder="noreply@example.com" />
                {errors.from_address && (
                  <p className="text-sm text-destructive">{errors.from_address.message}</p>
                )}
              </div>
              <div className="space-y-2">
                <Label htmlFor="from_name">From Name</Label>
                <Input id="from_name" {...register("from_name")} placeholder="My Application" />
                {errors.from_name && (
