...
return [
    ...
    [
        ...
        'url' => '/lists',
        'admin_only' => false,
        'content' => 'lists shopping groceries tracking price',
    ],
    [
        'id' => 'all-items',
        'title' => 'All Items',
        ...
        'url' => '/items',
        'admin_only' => false,
        'content' => 'items products all filter price drops target tracking',
    ],
    [
        'id' => 'smart-add',
        'title' => 'Smart Add',
        ...
        'url' => '/smart-add',
        'admin_only' => false,
        'content' => 'smart add ai image identify product camera upload',
    ],
    [
        'id' => 'product-search',
        ...
        'url' => '/search',
        'admin_only' => false,
        'content' => 'search product price compare image retailer vendor',
    ],
    [
        'id' => 'deals',
        'title' => 'Deals & Coupons',
        ...
        'url' => '/deals',
        'admin_only' => false,
        'content' => 'deals coupons scan flyer circular mailer savings discount coupon ad weekly',
    ],
    [
        'id' => 'ask-dana',
        'title' => 'Ask Dana',
        ...
        'url' => '/ask-dana',
        'admin_only' => false,
        'content' => 'ai assistant chat dana help ask bot conversation shopping prices',
    ],
    ...
    [
        ...
        'content' => 'price search crawl scrape firecrawl serpapi google places store discovery comparison shopping vendor',
    ],
    [
        'id' => 'config-stores',
        ...
        'admin_only' => true,
        'permission' => 'settings.view',
        'content' => 'stores store management preferences favorites suppressed custom local nearby discovery enable disable priority',
    ],
    [
        'id' => 'config-ai',
    ...
    [
        'id' => 'help-welcome',
        'title' => 'Help: Welcome to DanaVision',
