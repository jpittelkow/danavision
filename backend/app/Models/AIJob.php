...
class AIJob extends Model
{
    ...
    public const TYPE_LABELS = [
        ...
        self::TYPE_FIRECRAWL_DISCOVERY => 'Price Discovery',
        self::TYPE_FIRECRAWL_REFRESH => 'Price Refresh',
    ...
    public function getInputSummaryAttribute(): string
    {
        ...
        return match ($this->type) {
            ...
            self::TYPE_FIRECRAWL_DISCOVERY => $this->input_data['product_name'] ?? 'Price discovery',
            self::TYPE_FIRECRAWL_REFRESH => $this->input_data['product_name'] ?? 'Price refresh',
