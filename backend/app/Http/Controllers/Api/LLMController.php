...
class LLMController extends Controller
{
    ...
    public function destroyProvider(Request $request, int $provider): JsonResponse
    {
        ...
        return $this->successResponse('Provider removed');
    }
    ...
    public function query(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return $this->errorResponse('Query failed: ' . $e->getMessage(), 400);
        }
    }
    ...
    public function visionQuery(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return $this->errorResponse('Vision query failed: ' . $e->getMessage(), 400);
        }
    }
}
